...
def get_params():
    params = {
        'weight': '/root/ultralytics-yolo11-main/runs/train/CCFM-Detect_LSDECD-C3k2_WTConv3/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model(r'/root/PG-YOLO-Dataset-master/test/images', 'CCFM-Detect_LSDECD-C3k2_WTConv-heatMap')
