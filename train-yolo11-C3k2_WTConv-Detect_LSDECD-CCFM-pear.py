...
# nohup python train-yolo11-C3k2_WTConv-Detect_LSDECD-CCFM-pear.py > train-yolo11-C3k2_WTConv-Detect_LSDECD-CCFM-pear.log 2>&1 &
# tail -f train-yolo11-C3k2_WTConv-Detect_LSDECD-CCFM-pear.log
...
if __name__ == '__main__':
    ...
    model.train(data='/root/autodl-tmp/pear/data.yaml',
               task='detect',
                cache=False,
                imgsz=640,
                epochs=100,
                ...
                fraction=1,
                project='runs/train',
                name='CCFM-Detect_LSDECD-C3k2_WTConv-pear',
                )
    model = YOLO('/root/ultralytics-yolo11-main/runs/train/CCFM-Detect_LSDECD-C3k2_WTConv-pear/weights/best.pt') # 选择训练好的权重路径
    model.val(data='/root/autodl-tmp/pear/data.yaml',
    ...
    file_path = "runs/train/CCFM-Detect_LSDECD-C3k2_WTConv-pear/weights/best.pt"
