...
# nohup python train-yolo11-C3k2_WTConv-Detect_LSDECD-CCFM.py > train-yolo11-C3k2_WTConv-Detect_LSDECD-CCFM.log 2>&1 &
# tail -f train-yolo11-C3k2_WTConv-Detect_LSDECD-CCFM.log
...
if __name__ == '__main__':
    ...
    #             )
    model = YOLO('runs/train/CCFM-Detect_LSDECD-C3k2_WTConv/weights/best.pt') # 选择训练好的权重路径
    ...
    file_path = "runs/train/CCFM-Detect_LSDECD-C3k2_WTConv3/weights/best.pt"
